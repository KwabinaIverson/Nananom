...
const ServiceDetailPage = () => {
  ...
  const serviceData = {
    'premium-palm-oil-products': {
      ...
      icon: (
        <svg className="w-16 h-16 text-[#FFFFF0]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2-2m-2 2l-2 2M12 8l-2 2m2-2l2 2M12 18h.01M12 12h.01M12 6h.01M6 12h.01M18 12h.01"></path></svg>
      ),
      image: 'https://via.placeholder.com/800x400/4682B4/FFFFF0?text=Premium+Palm+Oil'
    },
    ...
    'farm-equipment-rentals': {
      ...
      image: 'https://via.placeholder.com/800x400/8A3324/FFFFF0?text=Farm+Equipment'
    },
    'training-workshops': {
      ...
      image: 'https://via.placeholder.com/800x400/4682B4/FFFFF0?text=Training+Workshop'
    },
    'logistics-distribution': {
      ...
      icon: (
        <svg className="w-16 h-16 text-[#FFFFF0]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10v11m0 0h8m-8 0L9 17m-3 4V3m0 0h8m-8 0L9 7m-3 4v10m6-10V3m0 0h8m-8 0L15 7m-3 4v10m6-10V3m0 0h8m-8 0L21 7"></path></svg>
      ),
      image: 'https://via.placeholder.com/800x400/EAA221/2F4F4F?text=Logistics+Distribution'
    },
    'agricultural-research-support': {
      ...
      icon: (
        <svg className="w-16 h-16 text-[#FFFFF0]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 4a2 2 0 100 4m-3.939 1.579a2 2 0 113.15 1.414L10 14l-1 1-3 3-1 1-3 3"></path></svg>
      ),
      image: 'https://via.placeholder.com/800x400/8A3324/FFFFF0?text=Agri+Research'
    },
  };
  ...
  const service = serviceData[id] || {
    ...
    icon: (
      <svg className="w-16 h-16 text-[#8A3324]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
    ),
    image: 'https://via.placeholder.com/800x400/F2F4F5/2F4F4F?text=Service+Not+Found'
  };


  return (
    <div className="container mx-auto p-4 py-12 bg-[#F2F4F5] min-h-screen font-sans animate-fadeIn">
      <div className="max-w-4xl mx-auto bg-[#FFFFF0] rounded-lg shadow-xl overflow-hidden border border-[#EAA221] animate-slideInUp">
        {/* Service Image */}
        <div className="relative h-64 sm:h-80 md:h-96 bg-cover bg-center" style={{ backgroundImage: `url('${service.image}')` }}>
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4">
            <div className="p-4 rounded-full bg-[#4682B4] shadow-lg animate-popIn">
              {service.icon}
            </div>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-[#4682B4] mb-4 animate-slideInDown">
            {service.title}
          </h1>
          <p className="text-lg md:text-xl text-[#2F4F4F] leading-relaxed mb-6 animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            Details for Service ID: <span className="font-semibold text-[#EAA221]">{id}</span>
          </p>
          <p className="text-base md:text-lg text-[#2F4F4F] leading-relaxed mb-8 animate-fadeIn" style={{ animationDelay: '0.4s' }}>
            {service.description}
          </p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link
              to="/enquiries"
              className="bg-[#EAA221] hover:bg-[#4682B4] text-[#2F4F4F] hover:text-[#FFFFF0] font-bold py-3 px-8 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105 animate-bounceIn" style={{ animationDelay: '0.6s' }}
            >
              Enquire About This Service
            </Link>
            <Link
              to="/services"
              className="bg-transparent border-2 border-[#4682B4] text-[#4682B4] hover:bg-[#4682B4] hover:text-[#FFFFF0] font-bold py-3 px-8 rounded-full transition duration-300 ease-in-out transform hover:scale-105 animate-fadeIn" style={{ animationDelay: '0.8s' }}
            >
              View All Services
            </Link>
          </div>
