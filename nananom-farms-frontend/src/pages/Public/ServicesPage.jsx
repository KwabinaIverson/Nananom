    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-green-700 text-white py-16 md:py-24 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto">
            ...
            optimize yields, and ensure sustainable agricultural growth.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div id="palm-oil-products" className="bg-gray-100 p-8 rounded-lg shadow-md mb-12">
            <h3 className="text-3xl font-bold text-green-700 mb-4">Premium Palm Oil Products</h3>
            ...
            <Link to="/enquiries" className="text-green-600 hover:text-green-800 font-semibold flex items-center">
          ...
          <div id="agricultural-consulting" className="bg-gray-100 p-8 rounded-lg shadow-md mb-12">
            <h3 className="text-3xl font-bold text-green-700 mb-4">Agricultural Consulting</h3>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <Link to="/enquiries" className="text-green-600 hover:text-green-800 font-semibold flex items-center">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"></path></svg>
              Request Agricultural Consulting
            </Link>
          </div>

          {/* Detailed Section: Farm Equipment Rentals */}
          <div id="farm-equipment-rentals" className="bg-gray-100 p-8 rounded-lg shadow-md mb-12">
            <h3 className="text-3xl font-bold text-green-700 mb-4">Farm Equipment Rentals</h3>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
          ...
          <div id="training-workshops" className="bg-gray-100 p-8 rounded-lg shadow-md mb-12">
            <h3 className="text-3xl font-bold text-green-700 mb-4">Training Workshops</h3>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
          ...
          <div id="logistics-distribution" className="bg-gray-100 p-8 rounded-lg shadow-md mb-12">
            <h3 className="text-3xl font-bold text-green-700 mb-4">Logistics & Distribution</h3>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <Link to="/enquiries" className="text-green-600 hover:text-green-800 font-semibold flex items-center">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10v11m0 0h8m-8 0L9 17m-3 4V3m0 0h8m-8 0L9 7m-3 4v10m6-10V3m0 0h8m-8 0L15 7m-3 4v10m6-10V3m0 0h8m-8 0L21 7"></path></svg>
              Discuss Distribution Needs
            </Link>
          </div>

          {/* Detailed Section: Agricultural Research Support */}
          <div id="agricultural-research-support" className="bg-gray-100 p-8 rounded-lg shadow-md mb-12">
            <h3 className="text-3xl font-bold text-green-700 mb-4">Agricultural Research Support</h3>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
            ...
            <Link to="/enquiries" className="text-green-600 hover:text-green-800 font-semibold flex items-center">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 4a2 2 0 100 4m-3.939 1.579a2 2 0 113.15 1.414L10 14l-1 1-3 3-1 1-3 3"></path></svg>
      ...
      <section className="bg-green-800 text-white py-16 md:py-24 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Ready to Partner With Nananom Farms?</h2>
          ...
          <Link
            to="/enquiries"
            className="inline-block bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105 text-lg"
          >
            Make an Enquiry
          </Link>
        </div>
